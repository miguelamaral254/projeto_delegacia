...
print("--- Módulo de Treinamento: Previsão de Violência (LightGBM) ---")
...
# --- CRIAÇÃO DA NOVA VARIÁVEL-ALVO ---
violent_crimes = [
    'Homicídio', 'Latrocínio', 'Roubo', 
    'Estupro', 'Sequestro', 'Violência Doméstica'
]
...
print("Relatório de Classificação (Violento vs. Não Violento):")
print(classification_report(y_test, y_pred, target_names=['Não Violento', 'Violento']))
...
print(f"Modelo de previsão de violência salvo em: {model_path}")
