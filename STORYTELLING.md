...
| **Informações Úteis** | A regra de similaridade é clara: *score* $\geq 3$ (com 3 fatores de similaridade) gera uma conexão. Permite identificar "células" ou "séries" criminais para investigação concentrada. |
